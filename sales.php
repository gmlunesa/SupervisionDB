<?php
	...
	$overallsales = mysql_query($salesquery);
	$salesbagtag = mysql_query($salesquerybagtag);
	$saleskeychain = mysql_query($salesquerykeychain);
	$salestarpaulin = mysql_query($salesquerytarpaulin);
	$salesshirt = mysql_query($salesqueryshirt);
	$salestumbler = mysql_query($salesquerytumbler);

	$sumsales = 0;

	while($row1 = mysql_fetch_array($overallsales)) {
	...
	while($row2 = mysql_fetch_array($salesbagtag)) {
	...
	while($row3 = mysql_fetch_array($saleskeychain)) {
	...
	while($row4 = mysql_fetch_array($salestarpaulin)) {
	...
	while($row5 = mysql_fetch_array($salesshirt)) {
	...
	while($row6 = mysql_fetch_array($salestumbler)) {
